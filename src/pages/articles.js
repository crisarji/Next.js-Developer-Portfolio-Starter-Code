...
const FeaturedArticles = ({ img, title, time, summary, link }) => {
  return (
    <li className="relative con-span-1 w-full p-4 bg-light border border-solid border-dark rounded-2xl dark:bg-dark dark:border-light">
...
export default function articles() {
  return (
    <>
      <Head>
        <title>Crisarji | Articles Page</title>
